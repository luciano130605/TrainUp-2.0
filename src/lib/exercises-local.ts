...
const ejerciciosLocal: EjercicioLocal[] = [
  ...
  { id: "0010", nombre: "Curl predicador (Maquina)", gif: "/gifs/predicador-maquina.gif", parteDelCuerpo: "Biceps", subMusculos: [], equipamiento: "Maquinas" },
  ...
  { id: "0053", nombre: "Abdominales cortos (Peso)", gif: "/gifs/abd-cortos-p.jpg", parteDelCuerpo: "Abdominales", equipamiento: "Mancuernas", subMusculos: [] },
